...
alt="flower-left"
className="absolute left-[0px] top-[1200px] w-[180px] pointer-events-none z-30"
/>

<img
src="/firoh-arofi/flower-right-bridegroom.gif"
alt="flower-right"
className="absolute right-[0px] top-[1200px] w-[180px] pointer-events-none z-30"
/>

<img
src="/firoh-arofi/flower-bottom-bridegroom.gif"
alt="flower-bottom"
className="absolute left-1/2 -translate-x-1/2 bottom-[-30px] w-full pointer-events-none z-30"
/>
